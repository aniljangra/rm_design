...
if ($current_slug == 'checkout')
{
    if ( !is_user_logged_in() ) {
	 ...
	 $productid = isset( $_GET['productid'] ) ? $_GET['productid'] : 82;
	 WC()->cart->empty_cart(); 
				...
				<div class="row">
				  <div class="col">
				    ...
				    <div class="pf-main">
                       ...
                       <a href="<?php echo site_url(); ?>/wp-login.php?action=logout&redirect_to=https%3A%2F%2Frmdesign.realmonkey.in%2Fsignup&_wpnonce=9e6fd08d24" class="account-name"> logout</a>
